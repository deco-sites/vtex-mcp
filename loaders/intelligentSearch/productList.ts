...
/**
 * @name intelligent_search_product_list
 * @description Get a list of products using a search query, collection id, or product ids. Uses the Intelligent Search API.
 */
const loader = async (
  expandedProps: Props,
  _req: Request,
  ...
  // deno-lint-ignore no-explicit-any
  const facets = withDefaultFacets(selectedFacets, ctx as any);
